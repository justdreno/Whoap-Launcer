...
export const ContentBrowser: React.FC<ContentBrowserProps> = ({ instanceId, version, loader, type, onClose }) => {
    ...
    const handleInstall = async () => {
        ...
        try {
            ...
            if (res.success) {
                showToast(`Installed ${selectedProject?.title}!`, 'success');
                                ...
                                projects.map(project => {
                                    ...
                                    return (
                                        <div
                                            ...
                                            className={`${styles.modCard} ${selectedProject?.project_id === project.project_id ? styles.selected : ''} ${installed ? styles.installed : ''}`}
