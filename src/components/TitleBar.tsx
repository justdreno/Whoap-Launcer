    ...
    return (
        <div className={`${styles.container} draggable`}>
            ...
            <div className={`${styles.right} no-drag`}>
                ...
                <button onClick={handleMinimize} className={styles.button}><Minus size={12} /></button>
                <button onClick={handleMaximize} className={styles.button}><Square size={10} /></button>
                <button onClick={handleClose} className={`${styles.button} ${styles.close}`}><X size={12} /></button>
            </div>
        </div>
    );
};
