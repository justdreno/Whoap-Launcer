...
import { Search, Download, WifiOff, Lock } from 'lucide-react';
...
export const ModpackBrowser: React.FC<ModpackBrowserProps> = ({ isOnline = true }) => {
        ...
        <div className={styles.container}>
            ...
            {!isOnline ? (
                <div className={styles.offlineLock}>
                    ...
                    <p>Modpack browser requires an active internet connection to search and download modpacks from Modrinth.</p>
